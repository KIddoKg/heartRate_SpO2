...
import 'package:heart_spo2/constants/constants.dart';
...
class CircleWavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final halfWidth = size.width / 4;
    final halfHeight = size.height / 4;
    ...
    List<Offset> computeOffsets(int length) {
      ...
      for (var i = 0; i < length; i++) {
        ...
        final r = MediaQuery.of(context).size.width*0.13 *
